...
export class EditJobComponent implements OnInit {
  ...
  loadJob(id: number): void {
    ...
    this.http.get<Job>(`http://localhost:https://smartrecruit-l27g.onrender.com/api/jobs/${id}/`, {
  ...
  onSubmit(): void {
    ...
    this.http.put(
      `http://localhost:https://smartrecruit-l27g.onrender.com/api/jobs/crud/${this.jobId}/`,
      this.jobForm.value,
      { withCredentials: true }
    ).subscribe({
      next: () => {
