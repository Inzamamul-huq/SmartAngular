...
export class ManageQuestionsComponent implements OnInit {
  ...
  loadQuestions(): void {
    ...
    this.http.get(`http://localhost:https://smartrecruit-l27g.onrender.com/api/getquestions/job/${this.jobId}/`, {
  ...
  onSubmit(): void {
    ...
    if (this.editingQuestion && this.editingQuestion.id) {
      ...
      this.http.put(`http://localhost:https://smartrecruit-l27g.onrender.com/api/crud/questions/${this.editingQuestion.id}/`, 
        questionWithId,
        { 
          withCredentials: true,
      ...
      // Create new question
      this.http.post('http://localhost:https://smartrecruit-l27g.onrender.com/api/createquestion/', 
        questionData,
        { withCredentials: true }
      ).subscribe({
        next: () => {
  ...
  deleteQuestion(id: number): void {
    if (confirm('Are you sure you want to delete this question? This action cannot be undone.')) {
      this.loading = true;
      this.http.delete(
        `http://localhost:https://smartrecruit-l27g.onrender.com/api/crud/questions/${id}/`,
        { 
          withCredentials: true,
